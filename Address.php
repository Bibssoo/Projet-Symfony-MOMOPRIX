...
class Address
{
     ...
     * @var string
     *
     * @ORM\Column(name="type", type="string", length=15, nullable=false, options={"default"="Livraison"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="floor", type="string", length=5, nullable=true)
     */
    private $floor;
